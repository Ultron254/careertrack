...
export function TrendChart({ points, labels, accent = 'teal', showValues = true }: TrendChartProps) {
          ...
          return (
            <g key={index}>
              ...
              {isLast ? (
                ...
                <circle cx={p.x} cy={p.y} r="3.2" fill="var(--surface)" stroke={colour} strokeWidth="2.25" />
              )}
