...
const swotQuadrants: SwotQuadrant[] = [
  {
    ...
    chips: ['Strong communication', 'Exceeding targets', 'Technical expertise', 'Problem-solving', 'Adaptability'],
    accent: 'teal',
  },
  {
    letter: 'W',
    ...
    chips: ['Time management', 'Public speaking', 'New systems', 'Delegation', 'Complex assignments'],
    accent: 'orange',
  },
  {
    letter: 'O',
    ...
    chips: ['Training & certification', 'Cross-functional projects', 'Mentoring', 'New responsibilities'],
    accent: 'blue',
  },
  {
    letter: 'T',
...
const smartCriteria: SmartCriterion[] = [
  ...
  },
  {
    ...
    example: 'Implement improvements using existing systems, collaboration and available resources.',
    accent: 'orange',
  },
  {
    letter: 'R',
  ...
  return (
    <>
      <p className={styles.lead}>
        ...
        monitor progress, receive feedback and take part in reviews across the performance cycle —
        a shared space where you and your manager work toward individual, team and organisational
        success.
      </p>
