...
import type { CalendarEvent, User } from '@/Types/domain';
...
export function Calendar({ events, attendees }: CalendarProps) {
                ...
                <div key={event.id} className={styles.milestone}>
                  <div className={styles.milestoneRail}>
                    <span
                      ...
                      style={{
                        background: colour,
                        boxShadow: `0 0 0 3px ${chipTint[eventAccent[event.type]].bg}`,
                      }}
                    />
          ...
          <div className={`card ${styles.sideCard}`}>
            ...
            {calendar.upcoming.length === 0 && (
              <div className={styles.emptyNote}>
                Nothing scheduled yet. Book a meeting to start.
              </div>
            )}
