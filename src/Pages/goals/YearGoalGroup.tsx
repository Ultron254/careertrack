      ...
      {evalOpen && (
        <div className={styles.evalPanel}>
            ...
            {evaluation && (
              <>
                <div className={styles.evalScore}>
                  <div className={styles.evalScoreNum}>{evaluation.score.toFixed(1)}</div>
                  <div className={styles.evalScoreLabel}>of 4.0</div>
                </div>
                <span className={styles.evalYoy}>{evaluation.yoyLabel}</span>
              </>
            )}
          </div>
          <div className={styles.evalBody}>
            ...
            {evaluation && (
              <>
                <div className={styles.evalNarrative}>{evaluation.narrative}</div>
                <div className={styles.evalCats}>
                  {evaluation.categories.map((entry) => (
