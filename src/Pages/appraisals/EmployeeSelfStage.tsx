...
export function EmployeeSelfStage({
  ...
  const navigate = (to: string) => void router.visit(to);
          ...
          <div className={`card ${styles.summaryCard}`}>
            ...
            <div className={styles.summaryList}>
              ...
              <div className={styles.summaryOverall}>
                ...
                <strong
                  style={{ color: a.overallRating ? ratingColour[a.overallRating] : undefined }}
                >
      ...
      <div className={`card ${styles.blockCard}`}>
        ...
        <div className={styles.growthList}>
          {a.growthAreas.length === 0 && (
            <div className={styles.placeholder}>Add an area you want to develop next year.</div>
          )}
