    ...
    table: {
      ...
      rows: [
        ...
        },
        {
          name: 'Revenue growth',
          avatarUserId: null,
          cells: ['20%', 'In progress', '2'],
          lastCellTone: 'caution',
        },
      ],
    },
    insights: {
      ...
      cards: [
        {
          ...
          tag: 'Momentum',
          accent: 'teal',
          text: 'People & Client goals are progressing 20% faster than your last cycle.',
          metric: '+20%',
          metricLabel: 'vs 2025',
        },
        {
          ...
          tag: 'Risk',
          accent: 'orange',
          text: 'Financial goal returned and untouched for 6 days. Edit and resubmit soon.',
          metric: '6d',
          metricLabel: 'idle',
        },
        {
          ...
          tag: 'Tip',
          accent: 'gold',
          text: 'Request one more peer review to strengthen your appraisal evidence.',
          metric: '6',
          metricLabel: 'reviews so far',
        },
      ],
      ...
      cards: [
        {
          ...
          tag: 'Bottleneck',
          accent: 'orange',
          text: 'Average review turnaround is 4.2 days, above the 2-day target.',
          metric: '4.2d',
          metricLabel: 'avg SLA',
        },
        {
          ...
          tag: 'Standout',
          accent: 'teal',
          text: 'Sana Patel’s goals show the strongest client-value alignment on the team.',
          metric: '3',
          metricLabel: 'self-rating',
        },
        {
          emoji: '💬',
          tag: 'Action',
          accent: 'gold',
          text: '2 team members haven’t booked a goal-review meeting yet.',
          metric: '2',
          metricLabel: 'to nudge',
        },
      ],
      ...
      cards: [
        {
          ...
          tag: 'Pattern',
          accent: 'blue',
          text: 'Departments with a kickoff meeting submit 22% faster on average.',
          metric: '+22%',
          metricLabel: 'with kickoff',
        },
        {
          emoji: '⚠️',
          tag: 'Risk',
          accent: 'orange',
          text: 'Creative & Media are below target with 44 employees still to submit.',
          metric: '44',
        ...
        },
        {
          ...
          tag: 'Flow',
          accent: 'gold',
          text: '4 returned goals await your review-loop sign-off, blocking edits.',
          metric: '4',
          metricLabel: 'in loop',
        },
      ],
      prompts: [
        'Who’s at risk of missing the deadline?',
        'Draft a reminder to Creative',
        'Explain the SLA dip',
      ],
    },
  },
      ...
      cards: [
        {
          ...
          tag: 'Health',
          accent: 'teal',
          text: 'All departments configured with categories and weightings.',
          metric: '100%',
        ...
        },
        {
          ...
          tag: 'Adoption',
          accent: 'blue',
          text: 'Weekly active users up 4 points since cycle open.',
          metric: '96%',
          metricLabel: 'WAU',
        },
        {
          ...
          tag: 'Fix',
          accent: 'orange',
          text: '2 managers have no reportees linked, so reviews cannot route.',
          metric: '2',
          metricLabel: 'to resolve',
        },
      ],
