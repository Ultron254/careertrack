...
export const dashboards: Record<Role, Dashboard> = {
  employee: {
    ...
    statusDonut: {
      title: 'Goal status',
      segments: [
        { label: 'Approved', share: 50, accent: 'teal', detail: '2 goals approved', target: '/goals?status=Approved' },
        { label: 'Under review', share: 25, accent: 'gold', detail: '1 goal under review', target: '/goals?status=Under Review' },
        { label: 'Returned', share: 25, accent: 'orange', detail: '1 goal returned', target: '/goals?status=Returned' },
      ],
    },
    ...
    categoryBars: {
      ...
      bars: [
        { label: 'Client', valueLabel: '30', heightPct: 100, accent: 'teal', detail: 'Client · 30% of your weight', target: '/goals' },
        { label: 'Co.', valueLabel: '20', heightPct: 66, accent: 'blue', detail: 'Company · 20% of your weight', target: '/goals' },
        { label: 'People', valueLabel: '30', heightPct: 100, accent: 'orange', detail: 'People · 30% of your weight', target: '/goals' },
        { label: 'Fin.', valueLabel: '20', heightPct: 66, accent: 'gold', detail: 'Financial · 20% of your weight', target: '/goals' },
      ],
    },
    list: {
      title: 'My goals',
    ...
    side: {
      title: 'Goal status',
      rows: [
        { label: 'Approved', count: '2', pct: 50, accent: 'teal', target: '/goals?status=Approved' },
        { label: 'Under review', count: '1', pct: 25, accent: 'gold', target: '/goals?status=Under Review' },
        { label: 'Returned', count: '1', pct: 25, accent: 'orange', target: '/goals?status=Returned' },
      ],
    },
  ...
  manager: {
    ...
    statusDonut: {
      ...
      segments: [
        { label: 'Approved', share: 33, accent: 'teal', detail: '2 of 6 approved', target: '/reviews?status=Approved' },
        { label: 'Under review', share: 50, accent: 'gold', detail: '3 of 6 under review', target: '/reviews?status=Under Review' },
        { label: 'Returned', share: 17, accent: 'orange', detail: '1 of 6 returned', target: '/reviews?status=Returned' },
      ],
    },
    ...
    categoryBars: {
      ...
      bars: [
        { label: 'Appr.', valueLabel: '2', heightPct: 66, accent: 'teal', detail: '2 approved · open queue', target: '/reviews?status=Approved' },
        { label: 'Rev.', valueLabel: '3', heightPct: 100, accent: 'gold', detail: '3 under review · action needed', target: '/reviews?status=Under Review' },
        { label: 'Ret.', valueLabel: '1', heightPct: 33, accent: 'orange', detail: '1 returned to the employee', target: '/reviews?status=Returned' },
        { label: 'New', valueLabel: '0', heightPct: 6, accent: 'blue', detail: '0 newly submitted', target: '/reviews?status=Submitted' },
      ],
    },
    list: {
      title: 'My team',
    ...
    side: {
      title: 'Submission status',
      rows: [
        { label: 'Approved', count: '2', pct: 33, accent: 'teal', target: '/reviews?status=Approved' },
        { label: 'Under review', count: '3', pct: 50, accent: 'gold', target: '/reviews?status=Under Review' },
        { label: 'Returned', count: '1', pct: 17, accent: 'orange', target: '/reviews?status=Returned' },
      ],
    },
  ...
  people_team: {
    ...
    statusDonut: {
      ...
      segments: [
        { label: 'Submitted', share: 87, accent: 'teal', detail: '298 of 342 submitted', target: '/people' },
        { label: 'Pending', share: 13, accent: 'orange', detail: '44 still pending', target: '/people' },
      ],
    },
    ...
    categoryBars: {
      title: 'By department',
      bars: [
        { label: 'Client', valueLabel: '93', heightPct: 93, accent: 'teal', detail: 'Client Service · 93% submitted', target: '/people' },
        { label: 'Creat.', valueLabel: '79', heightPct: 79, accent: 'orange', detail: 'Creative · 79% submitted', target: '/people' },
        { label: 'Digital', valueLabel: '94', heightPct: 94, accent: 'blue', detail: 'Digital · 94% submitted', target: '/people' },
        { label: 'Media', valueLabel: '81', heightPct: 81, accent: 'gold', detail: 'PR & Media · 81% submitted', target: '/people' },
      ],
    },
    list: {
  ...
  admin: {
    ...
    statusDonut: {
      title: 'Roles',
      segments: [
        { label: 'Employees', share: 88, accent: 'teal', detail: '301 employees', target: '/people' },
        { label: 'Managers', share: 8, accent: 'blue', detail: '28 line managers', target: '/people' },
        { label: 'HR + Exec', share: 4, accent: 'orange', detail: '13 HR and exec', target: '/people' },
      ],
    },
    ...
    categoryBars: {
      ...
      bars: [
        { label: 'Client', valueLabel: '96', heightPct: 96, accent: 'teal', detail: 'Client Service · 96% logged in this week', target: '/people' },
        { label: 'Digital', valueLabel: '92', heightPct: 92, accent: 'blue', detail: 'Digital · 92% logged in this week', target: '/people' },
        { label: 'Creat.', valueLabel: '84', heightPct: 84, accent: 'orange', detail: 'Creative · 84% logged in this week', target: '/people' },
        { label: 'Media', valueLabel: '88', heightPct: 88, accent: 'gold', detail: 'PR & Media · 88% logged in this week', target: '/people' },
      ],
    },
    list: {
