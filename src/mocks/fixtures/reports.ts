...
export const reports: Record<Role, Report> = {
  employee: {
    kpis: [
      ...
      { label: 'Feedback received', value: '6', delta: '+2', deltaTone: 'positive', sub: 'this cycle', accent: 'orange' },
      { label: 'Weight complete', value: '100%', delta: null, deltaTone: 'muted', sub: 'across 4 goals', accent: 'gold' },
    ],
    categoryBars: {
  ...
  manager: {
    kpis: [
      { label: 'Team avg rating', value: '3', delta: null, deltaTone: 'positive', sub: '6 reports', accent: 'blue' },
      { label: 'Goals approved', value: '92%', delta: null, deltaTone: 'muted', sub: 'of team goals', accent: 'teal' },
      { label: 'Reviews on time', value: '5/6', delta: null, deltaTone: 'negative', sub: '1 overdue', accent: 'orange' },
      { label: 'Appraisals done', value: '4/6', delta: null, deltaTone: 'muted', sub: 'year-end', accent: 'gold' },
    ],
    categoryBars: {
  ...
  people_team: {
    kpis: [
      ...
      { label: 'Review SLA', value: '71%', delta: '-4', deltaTone: 'negative', sub: 'within 14 days', accent: 'orange' },
  ...
  admin: {
    kpis: [
      ...
      { label: 'Weekly active', value: '96%', delta: '+4', deltaTone: 'positive', sub: 'since cycle open', accent: 'blue' },
      { label: 'Unlinked managers', value: '2', delta: null, deltaTone: 'negative', sub: 'no reports', accent: 'orange' },
